...
tso.data.live.functions.defineUnits = function () {
    ...
    cu.cFanatic          = new Unit("Fanatic",             20, [ 30,   60],  90, Initiative.SECOND, getAID(), [Skills.TOWER_BONUS]);            //
...
function defineAdventureMaps(units, adv_maps) {
    ...
    adv_maps.arcticExplosion   = [cu.nHousekarl, cu.nValkyrie, cu.nKarl, cu.nJomsviking];
